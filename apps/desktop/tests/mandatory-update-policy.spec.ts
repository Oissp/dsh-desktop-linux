...
describe('installed client identity validation', () => {
  ...
  const build = (change: Partial<DesktopPolicyIdentity>, clientChange: Partial<AccountClientMetadata> = {}): DesktopMandatoryUpdatePolicy =>
    new DesktopMandatoryUpdatePolicy(config, { ...identity, ...change }, () => {}, undefined,
      () => ({ ...client, ...clientChange }))
